...
export function EvidenceInspector({ vs }: EvidenceInspectorProps) {
  ...
  return (
    <div className="mt-4 rounded-2xl border border-pv-text/[0.08] bg-pv-surface overflow-hidden">
      {/* Header — always visible */}
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className="flex w-full items-center justify-between px-4 py-3 hover:bg-pv-text/[0.02] transition-colors"
      >
      ...
      {/* Expanded content */}
      {open && (
        <div className="border-t border-pv-text/[0.06] px-4 pb-4 pt-3 space-y-4">
          {/* Verdict */}
          <div>
          ...
          <div>
            ...
            <div className="h-1.5 rounded-full bg-pv-text/[0.06]">
              <div
          ...
          {hasEvidence && (
            <div>
              ...
              <p className="mt-1 text-[11px] text-pv-muted">
                The oracle fetched the evidence URL, hashed it with keccak256, and stored this hash on Mantle.
          ...
          {/* How to verify */}
          <div className="rounded-xl border border-pv-text/[0.06] bg-pv-text/[0.02] px-3 py-2">
            ...
            <ol className="text-[11px] text-pv-muted space-y-0.5 list-decimal list-inside">
              ...
              <li>
                <a
                  href={`https://explorer.sepolia.mantle.xyz/address/${vs.id}`}
                  target="_blank"
                  rel="noreferrer"
                  className="text-pv-cyan hover:text-pv-text"
                >
                  View settlement transaction on Mantle Explorer ↗
                </a>
              </li>
            </ol>
          </div>
